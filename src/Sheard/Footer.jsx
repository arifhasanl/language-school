...
const Footer = () => {
    return (
        <div className="bg-[#110032] mt-8">
            <footer className="footer p-10 bg-[#110032] text-base-content">
                <div>
            ...
            <footer className="footer px-10 py-4 bg-[#110032] border-t  text-base-content border-base-300">
